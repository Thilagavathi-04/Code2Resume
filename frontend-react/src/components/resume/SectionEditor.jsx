        ...
        <div className="flex items-center gap-2">
          ...
          {onAdd && (
            <span
              ...
              className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-gray-900 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-900/20 rounded-lg transition-colors"
            >
