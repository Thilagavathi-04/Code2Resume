...
class User(Base):
    ...
    education_field = Column(String(255), nullable=True)
    education_start_date = Column(String(50), nullable=True)
    education_end_date = Column(String(50), nullable=True)
    education_gpa = Column(String(20), nullable=True)
